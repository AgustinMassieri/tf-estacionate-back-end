...
const { registerController, loginController, getUsers, getUser, deleteUser, updateUser, uploadProfilePic, getUserByEmail, updateUserPassword } = require('../controllers/auth');
